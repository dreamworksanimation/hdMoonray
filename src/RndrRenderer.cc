...
#   endif // end DEBUG_MSG
    ...
    mRenderOptions->setThreads(mRenderOptions->getThreads() - 1);
...
bool
RndrRenderer::activate()
{
#   ifdef DEBUG_MSG
    std::cerr << ">> RndrRenderer.cc activate()\n";
#   endif // end DEBUG_MSG
...
bool
RndrRenderer::deactivate()
{
#   ifdef DEBUG_MSG
    std::cerr << ">> RndrRenderer.cc deactivate()\n";
#   endif // end DEBUG_MSG
